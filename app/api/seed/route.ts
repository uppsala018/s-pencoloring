/**
 * POST /api/seed — seeds Firestore with starter coloring pages.
 * Protected: requires X-Seed-Key header matching SEED_SECRET env var.
 * Run once after deploying. Set SEED_SECRET in your environment.
 */
...
const PAGES = [
  {
    ...
    difficulty: "medium",
    isFree: true,
    svgUrl: "/coloring-pages/noahs-ark.svg",
    thumbnailUrl: "/coloring-pages/noahs-ark.svg",
    regionCount: 20,
    palette: [
  ...
  },
  {
    ...
    difficulty: "hard",
    isFree: false,
    svgUrl: "/coloring-pages/enchanted-forest.svg",
    thumbnailUrl: "/coloring-pages/enchanted-forest.svg",
    regionCount: 35,
    palette: [
  ...
  },
  {
    ...
    difficulty: "medium",
    isFree: false,
    svgUrl: "/coloring-pages/ocean-serenity.svg",
    thumbnailUrl: "/coloring-pages/ocean-serenity.svg",
    regionCount: 28,
    palette: [
      ...
      { number: 6, hex: "#98FB98", name: "Anemone" },
      { number: 7, hex: "#E0F7FA", name: "Foam" },
      { number: 8, hex: "#FF69B4", name: "Tropical Fish" },
  ...
  },
  {
    ...
    difficulty: "hard",
    isFree: false,
    svgUrl: "/coloring-pages/mandala-peace.svg",
    thumbnailUrl: "/coloring-pages/mandala-peace.svg",
    regionCount: 42,
    palette: [
      ...
      { number: 10, hex: "#F0F0F0", name: "Pearl" },
    ],
  },
  {
    ...
    difficulty: "easy",
    isFree: false,
    svgUrl: "/coloring-pages/garden-bloom.svg",
    thumbnailUrl: "/coloring-pages/garden-bloom.svg",
    regionCount: 18,
    palette: [
      ...
      { number: 5, hex: "#80CBC4", name: "Sky Teal" },
...
export async function POST(req: NextRequest) {
  ...
  for (const page of PAGES) {
    ...
    results.push(`${ref.id}: ${page.title}`);
  }
